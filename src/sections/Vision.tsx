...
export default function Vision() {
  ...
  return (
    ...
    >
      <Aurora flip amplitude={0.9} blend={0.65} colorStops={['#0f7a58', '#37e6a6', '#9be8ff']} />

      <div className="relative z-10 max-w-6xl">
        <div className="overflow-hidden">
          <p className="vision-kicker text-mint font-mono text-[10px] tracking-[0.3em] md:text-xs">
            06/ — {vision.kicker}
          </p>
        </div>

        <p className="vision-line face-poster text-ivory mt-8 text-[8.4vw] leading-[1.04] font-medium italic md:text-[4.6vw]">
          {vision.line}
        </p>
        ...
        >
          <path
            ...
            strokeLinecap="round"
          />
          <circle className="vision-dot" cx="1160" cy="24" r="10" fill="var(--color-ivory)" />
        </svg>
      </div>
    </section>
  )
